...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
		...
		init = function () {
			...
			crayonImage.src = "https://i.ibb.co/VVbc7M3/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "https://i.ibb.co/1ZqDMq7/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "https://i.ibb.co/C2H15ps/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "https://i.ibb.co/dQbxHfs/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "https://i.ibb.co/NCnPHWk/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "https://i.ibb.co/c2BwPjB/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "https://i.ibb.co/Ldzccm1/crayon-texture.png";

			outlineImage.onload = resourceLoaded;
			outlineImage.src = "https://i.ibb.co/hg09wXT/xyz.png";
		};
